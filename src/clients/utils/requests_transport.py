...
cat_relay note:  Shamelessly borrowed from pyfldigi, which in turn borrowed it from
...
Oh, and I made it HTTP only because flrig doesn't support HTTPS as far as I know.
...
class RequestsTransport(Transport):
    ...
    >>> from src.clients.radio_control import RequestsTransport
